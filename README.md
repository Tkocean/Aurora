...
## Manual Install:
- Step 1: Download the source files from the Source page and extract them. Move the main program `Aurora` from the `/system/bin/` directory inside the extracted folder into the system variable, e.g. `/data/adb/ksu/bin`.
