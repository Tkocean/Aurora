...
## Installation
- [Suggest] Download the module package from the [Release](https://github.com/Tkocean/Aurora/releases/download/Light-Weight/Aurora.zip) page, and install it via Magisk Manager, KernelSU Manager, or APatch.
